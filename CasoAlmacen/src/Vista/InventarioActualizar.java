 ...
 * @author linco
 */
public class InventarioActualizar extends javax.swing.JFrame {

    /**
     * Creates new form InventarioInsertar
     */
    public InventarioActualizar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Inserte nombre de la tabla");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        InventarioAcciones ventana = new InventarioAcciones();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventarioActualizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InventarioActualizar().setVisible(true);
            }
        });
    }
