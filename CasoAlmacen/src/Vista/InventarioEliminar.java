 ...
 * @author linco
 */
public class InventarioEliminar extends javax.swing.JFrame {

    /**
     * Creates new form InventarioInsertar
     */
    public InventarioEliminar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventarioEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InventarioEliminar().setVisible(true);
            }
        });
    }
