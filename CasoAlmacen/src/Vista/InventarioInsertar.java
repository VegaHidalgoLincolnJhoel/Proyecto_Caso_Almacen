 ...
 * @author linco
 */
public class InventarioInsertar extends javax.swing.JFrame {

    /**
     * Creates new form InventarioInsertar
     */
    public InventarioInsertar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventarioInsertar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InventarioInsertar().setVisible(true);
            }
        });
    }
